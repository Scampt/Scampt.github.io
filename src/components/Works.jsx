            ...
            >
                {works.map((work, index) => (
                    ...
                    >
                        ...
                        >
                            <a href={work.link} target='_blank' className={`works__link ${work.className}`}>{language.worksLinkWebiste}</a>
                            <a href={work.linkGithub} target='_blank' className={`works__link github-code`}>{language.worksLinkGithub}</a>
                        </motion.div>
                    </motion.div>
                ))}
                <motion.figure 
                    className="works__design"
                >
                    <div 
                        className="works__design__item"
                    >
                        <motion.img 
                    ...
                    >
                        ...
                        />
                        <div 
                            className="works__design__text luthertft-text"
                        >
